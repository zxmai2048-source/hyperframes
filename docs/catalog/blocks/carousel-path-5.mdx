...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-path-5.html"
  title="Path Carousel 5"
  description="Image cards ride an open bezier path (arc, V, diagonal, wave, S-curve) with depth scaling and tangent rotation (Path style 5); 24 image slots."
  ...
  meta={{"duration":6,"width":1920,"height":1080,"category":"Carousels","badge":"Stable","codeLines":1045}}
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-path-5","tags":["carousel","gallery","images","showcase","path"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-path-5/carousel-path-5.html"
>

<CatalogSlot slot="code">

```html carousel-path-5.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Path 5</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-path-5"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-path-5-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-path-5-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-path-5-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [230.8, 107.7], in: [0, 0], out: [0, 546.6] },
            { p: [1905, 1085.2], in: [-946.6, -31.3], out: [946.6, 31.3] },
            { p: [3451.1, 1963.7], in: [-174.8, -585.2], out: [0, 0] },
          ],
          closed: false,
        },
        keys: {
          "Depth Angle": [
            {
              ...
              easeOut: { speed: -531.585759, influence: 0.138249 },
            },
            {
              time: 1.56667,
              value: -123.6,
              flags: "02020000",
              easeIn: { speed: -705.408948, influence: 0.121209 },
          ...
          "Move Carousel": [
            {
              ...
              flags: "02020000",
              easeIn: { speed: 0, influence: 0.333333 },
              easeOut: { speed: 325.205156, influence: 0.138498 },
            },
            {
              time: 1.53333,
              value: 89,
              flags: "02020000",
              easeIn: { speed: 186.896124, influence: 0.229377 },
              easeOut: { speed: 0, influence: 0.333333 },
            },
          ],
        },
...
<div
  data-composition-id="carousel-path-5"
  data-composition-src="compositions/carousel-path-5.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
