...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-vision-2.html"
  title="Vision Carousel 2"
  description="A ring of large image cards tilted into a row under a 3D camera, each card turning toward the centre (Vision style 2); 12 image slots."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-vision-2","tags":["carousel","gallery","images","showcase","vision","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-vision-2/carousel-vision-2.html"
>

<CatalogSlot slot="code">

```html carousel-vision-2.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Vision 2</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-vision-2"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-vision-2-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-vision-2-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-vision-2-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [1920, 230.6], in: [-409.239, 0], out: [409.24, 0] },
            { p: [2661, 1101.45], in: [0, -480.953], out: [0, 480.953] },
            { p: [1920, 1972.3], in: [409.24, 0], out: [-409.239, 0] },
            { p: [1179, 1101.45], in: [0, 480.953], out: [0, -480.953] },
          ],
          closed: true,
        },
        keys: {
...
<div
  data-composition-id="carousel-vision-2"
  data-composition-src="compositions/carousel-vision-2.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
