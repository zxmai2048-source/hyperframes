...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-circle-1.html"
  title="Circle Carousel 1"
  description="Image cards ride a circle with a size gradient by depth angle, sweeping in fast-slow-fast swings (Circle style 1); 12 image slots."
...
>
  <head>
    ...
    <title>Image Carousel · Circle 1</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-circle-1"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-circle-1-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-circle-1-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-circle-1-stage" class="stage"></div>
        </div>
      </div>
    </div>
...
<div
  data-composition-id="carousel-circle-1"
  data-composition-src="compositions/carousel-circle-1.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
