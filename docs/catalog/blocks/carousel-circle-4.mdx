...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-circle-4.html"
  title="Circle Carousel 4"
  description="Image cards ride a circle with a size gradient by depth angle, sweeping in fast-slow-fast swings (Circle style 4); 12 image slots."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-circle-4","tags":["carousel","gallery","images","showcase","circle"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-circle-4/carousel-circle-4.html"
>

<CatalogSlot slot="code">

```html carousel-circle-4.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Circle 4</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-circle-4"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-circle-4-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-circle-4-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-circle-4-stage" class="stage"></div>
        </div>
      </div>
    </div>
...
<div
  data-composition-id="carousel-circle-4"
  data-composition-src="compositions/carousel-circle-4.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
