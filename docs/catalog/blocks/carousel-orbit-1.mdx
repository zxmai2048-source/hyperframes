...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-orbit-1.html"
  title="Orbit Carousel 1"
  description="Image cards on a spinning 3D Fibonacci sphere, billboarded to the camera, sized by camera distance (Orbit style 1); 24 image slots."
  ...
  meta={{"duration":6,"width":1920,"height":1080,"category":"Carousels","badge":"Stable","codeLines":1024}}
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-orbit-1","tags":["carousel","gallery","images","showcase","orbit","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-orbit-1/carousel-orbit-1.html"
>

<CatalogSlot slot="code">

```html carousel-orbit-1.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Orbit 1</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-orbit-1"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-orbit-1-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-orbit-1-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-orbit-1-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        controls: {
          ...
          rotationY: 813,
          rotationZ: 26,
          perspectiveBoost: 84.9,
          scaleMin: -15.4,
          scaleMax: 11,
          spinDegPerSec: 175.38422992476941,
          spinTurns: { x: 0, y: 1, z: 0 },
        },
        comp: {
          width: 3840,
          height: 2160,
          ...
          "Rotation Y": [
            {
              ...
              easeOut: { speed: 840.336559, influence: 0.124734 },
            },
            {
              time: 1.51667,
              value: 1079,
              flags: "02020000",
              easeIn: { speed: 1984.087751, influence: 0.063927 },
...
<div
  data-composition-id="carousel-orbit-1"
  data-composition-src="compositions/carousel-orbit-1.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
...
Tagged `carousel` `gallery` `images` `showcase` `orbit` `3d`.
