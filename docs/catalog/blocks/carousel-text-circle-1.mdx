...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-text-circle-1.html"
  title="Text + Circle Carousel 1"
  description="A headline mask-reveals word by word while a circle carousel converges from off-frame and threads the line, collapses to centre, hard-cuts to a second line that arrives at 1.4× (Circle style 1)."
...
>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-text-circle-1"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="5"
    ...
    >
      <div id="carousel-text-circle-1-partA" class="clip" data-start="0" data-duration="3">
        <div data-hf-id="hf-elyu" id="carousel-text-circle-1-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-text-circle-1-stage" class="stage"></div>
        </div>
      </div>
      <div id="carousel-text-circle-1-outro" class="clip" data-start="3" data-duration="2">
        <div class="scaler" style="transform: scale(0.5)">
          <div class="stage">
            <div id="carousel-text-circle-1-outro-line" class="textline">
              <div id="carousel-text-circle-1-outro-drift" class="textdrift"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [2228.028, 354.208], in: [-357.877, 0], out: [357.877, 0] },
            { p: [2876.028, 1002.208], in: [0, -357.877], out: [0, 357.877] },
            { p: [2228.028, 1650.208], in: [357.877, 0], out: [-357.877, 0] },
            { p: [1580.028, 1002.208], in: [0, 357.877], out: [0, -357.877] },
          ],
          closed: true,
        },
        keys: {
...
<div
  data-composition-id="carousel-text-circle-1"
  data-composition-src="compositions/carousel-text-circle-1.html"
  data-start="0"
  data-duration="5"
  data-track-index="1"
  data-width="1920"
...
| `line1` | `Carousels are so in` | string | First line; words reveal one by one right to left and drift to centre. |
| `line2` | `so we made them in hf` | string | Line after the hard cut; arrives at 1.4× and settles to 1.0. |
