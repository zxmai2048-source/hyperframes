...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-text-circle-3.html"
  title="Text + Circle Carousel 3"
  description="A headline mask-reveals word by word while a circle carousel converges from off-frame and threads the line, collapses to centre, hard-cuts to a second line that arrives at 1.4× (Circle style 3)."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-text-circle-3","tags":["carousel","title-card","kinetic-text","images","showcase","circle"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-text-circle-3/carousel-text-circle-3.html"
>

<CatalogSlot slot="code">

```html carousel-text-circle-3.html
<!doctype html>
<html
  lang="en"
...
<div
  data-composition-id="carousel-text-circle-3"
  data-composition-src="compositions/carousel-text-circle-3.html"
  data-start="0"
  data-duration="5"
  data-track-index="1"
  data-width="1920"
