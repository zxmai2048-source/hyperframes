...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-vision-4.html"
  title="Vision Carousel 4"
  description="A ring of large image cards tilted into a row under a 3D camera, each card turning toward the centre (Vision style 4); 12 image slots."
  ...
  meta={{"duration":6,"width":1920,"height":1080,"category":"Carousels","badge":"Stable","codeLines":1013}}
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-vision-4","tags":["carousel","gallery","images","showcase","vision","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-vision-4/carousel-vision-4.html"
>

<CatalogSlot slot="code">

```html carousel-vision-4.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Vision 4</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-vision-4"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-vision-4-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-vision-4-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-vision-4-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        controls: {
          ...
          ySlider: 0,
          yAngle3d: -100,
          parent: { position: [1920, 1080, 0], anchor: [1920, 1080, 0] },
        },
        comp: {
          width: 3840,
          height: 2160,
        ...
        path: {
          vertices: [
            { p: [1920, 230.6], in: [-504.121, 0], out: [504.121, 0] },
            { p: [2832.8, 1101.45], in: [0, -480.953], out: [0, 480.953] },
            { p: [1920, 1972.3], in: [504.121, 0], out: [-504.121, 0] },
            { p: [1007.2, 1101.45], in: [0, 480.953], out: [0, -480.953] },
          ],
          closed: true,
        },
        keys: {
          "Move Carousel": [
            {
              ...
              easeOut: { speed: 18.612383, influence: 0.566866 },
            },
            {
              time: 0.76667,
              value: 33.131664,
              flags: "02020000",
              easeIn: { speed: 0, influence: 0.94525 },
              easeOut: { speed: 0, influence: 0.952878 },
            },
            {
              time: 1.51667,
              value: 0,
              flags: "02020000",
              easeIn: { speed: -16.673343, influence: 0.680917 },
              easeOut: { speed: 203.499248, influence: 0.110523 },
            },
          ],
        },
        motion: {
...
<div
  data-composition-id="carousel-vision-4"
  data-composition-src="compositions/carousel-vision-4.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
