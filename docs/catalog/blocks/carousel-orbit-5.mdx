...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-orbit-5.html"
  title="Orbit Carousel 5"
  description="Image cards on a spinning 3D Fibonacci sphere, billboarded to the camera, sized by camera distance (Orbit style 5); 24 image slots."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-orbit-5","tags":["carousel","gallery","images","showcase","orbit","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-orbit-5/carousel-orbit-5.html"
>

<CatalogSlot slot="code">

```html carousel-orbit-5.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Orbit 5</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-orbit-5"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-orbit-5-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-orbit-5-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-orbit-5-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        controls: {
          ...
          rotationY: 184,
          rotationZ: 90,
          perspectiveBoost: 114.6,
          scaleMin: -0.3,
          scaleMax: 21.1,
          spinDegPerSec: 151.53333333333333,
          ...
          "Rotation Y": [
            {
              ...
              easeOut: { speed: -726.055701, influence: 0.124734 },
            },
            {
              time: 1.5,
              value: -43.3,
              flags: "02020000",
              easeIn: { speed: -1714.26342, influence: 0.063927 },
...
<div
  data-composition-id="carousel-orbit-5"
  data-composition-src="compositions/carousel-orbit-5.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
