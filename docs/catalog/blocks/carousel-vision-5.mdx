...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-vision-5.html"
  title="Vision Carousel 5"
  description="A ring of large image cards tilted into a row under a 3D camera, each card turning toward the centre (Vision style 5); 12 image slots."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-vision-5","tags":["carousel","gallery","images","showcase","vision","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-vision-5/carousel-vision-5.html"
>

<CatalogSlot slot="code">

```html carousel-vision-5.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Vision 5</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-vision-5"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-vision-5-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-vision-5-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-vision-5-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [1901.05, 430.925], in: [-786.051, 0], out: [786.051, 0] },
            { p: [3324.334, 1099.05], in: [0, -368.992], out: [0, 368.992] },
            { p: [1901.05, 1767.175], in: [786.051, 0], out: [-786.051, 0] },
            { p: [477.766, 1099.05], in: [0, 368.992], out: [0, -368.992] },
          ],
          closed: true,
        },
        keys: {
          "Move Carousel": [
            {
              ...
              easeOut: { speed: -148.222195, influence: 0.208242 },
            },
            {
              time: 1.51667,
              value: -65,
              flags: "02020000",
              easeIn: { speed: -310.998269, influence: 0.114582 },
...
<div
  data-composition-id="carousel-vision-5"
  data-composition-src="compositions/carousel-vision-5.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
