...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-path-1.html"
  title="Path Carousel 1"
  description="Image cards ride an open bezier path (arc, V, diagonal, wave, S-curve) with depth scaling and tangent rotation (Path style 1); 24 image slots."
  ...
  meta={{"duration":6,"width":1920,"height":1080,"category":"Carousels","badge":"Stable","codeLines":1046}}
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-path-1","tags":["carousel","gallery","images","showcase","path"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-path-1/carousel-path-1.html"
>

<CatalogSlot slot="code">

```html carousel-path-1.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Path 1</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-path-1"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-path-1-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-path-1-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-path-1-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [1711, 1852.2], in: [0, 0], out: [0, 0] },
            { p: [1296.781, 828.793], in: [-599.805, 681.095], out: [233.9, -265.6] },
            { p: [2385.699, 479.619], in: [-522.577, -80.694], out: [1061.206, 163.867] },
            { p: [2848.5, 1653.3], in: [0, 0], out: [0, 0] },
          ],
          closed: false,
        },
        keys: {
          "Move Carousel": [
            {
              ...
              easeOut: { speed: 349.272605, influence: 0.073989 },
            },
            {
              time: 1.53333,
              value: -42.899998,
              flags: "02020000",
              easeIn: { speed: 131.14541, influence: 0.203595 },
...
<div
  data-composition-id="carousel-path-1"
  data-composition-src="compositions/carousel-path-1.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
