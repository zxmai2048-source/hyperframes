...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-orbit-2.html"
  title="Orbit Carousel 2"
  description="Image cards on a spinning 3D Fibonacci sphere, billboarded to the camera, sized by camera distance (Orbit style 2); 24 image slots."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-orbit-2","tags":["carousel","gallery","images","showcase","orbit","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-orbit-2/carousel-orbit-2.html"
>

<CatalogSlot slot="code">

```html carousel-orbit-2.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Orbit 2</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-orbit-2"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-orbit-2-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-orbit-2-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-orbit-2-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        controls: {
          ...
          scaleMin: -35.4,
          scaleMax: -5.2,
          spinDegPerSec: 177.33333333333334,
          ...
          "Rotation Y": [
            {
              ...
              easeOut: { speed: 849.673632, influence: 0.124734 },
            },
            {
              time: 1.5,
              value: 1079,
              flags: "02020000",
              easeIn: { speed: 2006.13317, influence: 0.063927 },
...
<div
  data-composition-id="carousel-orbit-2"
  data-composition-src="compositions/carousel-orbit-2.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
