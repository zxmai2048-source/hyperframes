...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-orbit-4.html"
  title="Orbit Carousel 4"
  description="Image cards on a spinning 3D Fibonacci sphere, billboarded to the camera, sized by camera distance (Orbit style 4); 24 image slots."
  ...
  meta={{"duration":6,"width":1920,"height":1080,"category":"Carousels","badge":"Stable","codeLines":1040}}
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-orbit-4","tags":["carousel","gallery","images","showcase","orbit","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-orbit-4/carousel-orbit-4.html"
>

<CatalogSlot slot="code">

```html carousel-orbit-4.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Orbit 4</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-orbit-4"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-orbit-4-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-orbit-4-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-orbit-4-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        controls: {
          ...
          scaleMin: -20.7,
          scaleMax: -0.4,
          spinDegPerSec: 159.33333333333334,
          spinTurns: { x: 0.047671936316275434, y: -1, z: 0 },
        },
        comp: {
          width: 3840,
          height: 2160,
          outWidth: 1920,
          outHeight: 1080,
          cameraZoom: 1022.2222,
          cameraDistance: 1022.2222,
          duration: 6,
          fps: 30,
        },
        n: 24,
          ...
          "Rotation Y": [
            {
              ...
              easeOut: { speed: -708.913926, influence: 0.178046 },
            },
            {
              time: 1.5,
              value: -280,
              flags: "02020000",
              easeIn: { speed: -2018.614608, influence: 0.069091 },
...
<div
  data-composition-id="carousel-orbit-4"
  data-composition-src="compositions/carousel-orbit-4.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
