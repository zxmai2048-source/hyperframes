...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-text-circle-4.html"
  title="Text + Circle Carousel 4"
  description="A headline mask-reveals word by word while a circle carousel converges from off-frame and threads the line, collapses to centre, hard-cuts to a second line that arrives at 1.4× (Circle style 4)."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-text-circle-4","tags":["carousel","title-card","kinetic-text","images","showcase","circle"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-text-circle-4/carousel-text-circle-4.html"
>

<CatalogSlot slot="code">

```html carousel-text-circle-4.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Carousels are so in — Circle 4</title>
    <link
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-text-circle-4"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="5"
    ...
    >
      <div id="carousel-text-circle-4-partA" class="clip" data-start="0" data-duration="3">
        <div data-hf-id="hf-elyu" id="carousel-text-circle-4-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-text-circle-4-stage" class="stage"></div>
        </div>
      </div>
      <div id="carousel-text-circle-4-outro" class="clip" data-start="3" data-duration="2">
        <div class="scaler" style="transform: scale(0.5)">
          <div class="stage">
            <div id="carousel-text-circle-4-outro-line" class="textline">
              <div id="carousel-text-circle-4-outro-drift" class="textdrift"></div>
            </div>
          </div>
        </div>
      </div>
...
<div
  data-composition-id="carousel-text-circle-4"
  data-composition-src="compositions/carousel-text-circle-4.html"
  data-start="0"
  data-duration="5"
  data-track-index="1"
  data-width="1920"
