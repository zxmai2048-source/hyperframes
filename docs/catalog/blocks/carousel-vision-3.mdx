...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-vision-3.html"
  title="Vision Carousel 3"
  description="A ring of large image cards tilted into a row under a 3D camera, each card turning toward the centre (Vision style 3); 12 image slots."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-vision-3","tags":["carousel","gallery","images","showcase","vision","3d"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-vision-3/carousel-vision-3.html"
>

<CatalogSlot slot="code">

```html carousel-vision-3.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Vision 3</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-vision-3"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-vision-3-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-vision-3-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-vision-3-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [1920, 230.6], in: [-538.473, 0], out: [538.473, 0] },
            { p: [2895, 1101.45], in: [0, -480.953], out: [0, 480.953] },
            { p: [1920, 1972.3], in: [538.473, 0], out: [-538.473, 0] },
            { p: [945, 1101.45], in: [0, 480.953], out: [0, -480.953] },
          ],
          closed: true,
        },
        keys: {
          "Move Carousel": [
            {
              ...
              easeOut: { speed: 203.499248, influence: 0.113746 },
            },
            {
              time: 1.51667,
              value: 50,
              flags: "02020000",
              easeIn: { speed: 334.222748, influence: 0.066959 },
...
<div
  data-composition-id="carousel-vision-3"
  data-composition-src="compositions/carousel-vision-3.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
