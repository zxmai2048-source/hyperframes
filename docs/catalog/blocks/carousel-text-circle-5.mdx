...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-text-circle-5.html"
  title="Text + Circle Carousel 5"
  description="A headline mask-reveals word by word while a circle carousel converges from off-frame and threads the line, collapses to centre, hard-cuts to a second line that arrives at 1.4× (Circle style 5)."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-text-circle-5","tags":["carousel","title-card","kinetic-text","images","showcase","circle"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-text-circle-5/carousel-text-circle-5.html"
>

<CatalogSlot slot="code">

```html carousel-text-circle-5.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Carousels are so in — Circle 5</title>
    <link
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-text-circle-5"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="5"
    ...
    >
      <div id="carousel-text-circle-5-partA" class="clip" data-start="0" data-duration="3">
        <div data-hf-id="hf-elyu" id="carousel-text-circle-5-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-text-circle-5-stage" class="stage"></div>
        </div>
      </div>
      <div id="carousel-text-circle-5-outro" class="clip" data-start="3" data-duration="2">
        <div class="scaler" style="transform: scale(0.5)">
          <div class="stage">
            <div id="carousel-text-circle-5-outro-line" class="textline">
              <div id="carousel-text-circle-5-outro-drift" class="textdrift"></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [1920.0, 231.523], in: [-468.543, 0], out: [468.543, 0] },
            { p: [2768.379, 1080.0], in: [0, -468.597], out: [0, 468.597] },
            { p: [1920.0, 1928.478], in: [468.543, 0], out: [-468.543, 0] },
            { p: [1071.621, 1080.0], in: [0, 468.597], out: [0, -468.597] },
          ],
          closed: true,
        },
        keys: {
...
<div
  data-composition-id="carousel-text-circle-5"
  data-composition-src="compositions/carousel-text-circle-5.html"
  data-start="0"
  data-duration="5"
  data-track-index="1"
  data-width="1920"
