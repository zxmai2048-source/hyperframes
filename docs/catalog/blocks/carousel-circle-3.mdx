...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-circle-3.html"
  title="Circle Carousel 3"
  description="Image cards ride a circle with a size gradient by depth angle, sweeping in fast-slow-fast swings (Circle style 3); 12 image slots."
  ...
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-circle-3","tags":["carousel","gallery","images","showcase","circle"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-circle-3/carousel-circle-3.html"
>

<CatalogSlot slot="code">

```html carousel-circle-3.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Circle 3</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-circle-3"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-circle-3-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-circle-3-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-circle-3-stage" class="stage"></div>
        </div>
      </div>
    </div>
...
<div
  data-composition-id="carousel-circle-3"
  data-composition-src="compositions/carousel-circle-3.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
