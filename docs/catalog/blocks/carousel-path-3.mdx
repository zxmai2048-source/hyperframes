...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-path-3.html"
  title="Path Carousel 3"
  description="Image cards ride an open bezier path (arc, V, diagonal, wave, S-curve) with depth scaling and tangent rotation (Path style 3); 12 image slots."
  ...
  meta={{"duration":6,"width":1920,"height":1080,"category":"Carousels","badge":"Stable","codeLines":1017}}
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-path-3","tags":["carousel","gallery","images","showcase","path"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-path-3/carousel-path-3.html"
>

<CatalogSlot slot="code">

```html carousel-path-3.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Path 3</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-path-3"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-path-3-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-path-3-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-path-3-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [142.6, 2401], in: [0, 0], out: [0, -956.4] },
            { p: [1969.8, 1090.5], in: [-1182.6, 0], out: [1099.3, 0] },
            { p: [3843.6, -357.5], in: [-4.8, 725.5], out: [0, 0] },
          ],
          closed: false,
        },
        keys: {
          ...
          "Move Carousel": [
            {
              ...
              easeOut: { speed: 4324.298211, influence: 0.009677 },
            },
            {
              time: 1.51667,
              value: 78.3,
              flags: "02020000",
              easeIn: { speed: 165.804634, influence: 0.236844 },
              easeOut: { speed: 0, influence: 0.166667 },
            },
          ],
        },
...
<div
  data-composition-id="carousel-path-3"
  data-composition-src="compositions/carousel-path-3.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
