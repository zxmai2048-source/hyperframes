...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-path-2.html"
  title="Path Carousel 2"
  description="Image cards ride an open bezier path (arc, V, diagonal, wave, S-curve) with depth scaling and tangent rotation (Path style 2); 12 image slots."
  ...
  meta={{"duration":6,"width":1920,"height":1080,"category":"Carousels","badge":"Stable","codeLines":1003}}
  attribution={{"author":"Jake Moran","path":"registry/blocks/carousel-path-2","tags":["carousel","gallery","images","showcase","path"]}}
  hasCode
  rawUrl="https://raw.githubusercontent.com/heygen-com/hyperframes/main/registry/blocks/carousel-path-2/carousel-path-2.html"
>

<CatalogSlot slot="code">

```html carousel-path-2.html
<!doctype html>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Image Carousel · Path 2</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-path-2"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-path-2-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-path-2-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-path-2-stage" class="stage"></div>
        </div>
      </div>
    </div>
    ...
    <script>
      const DATA = {
        ...
        path: {
          vertices: [
            { p: [388.6, 368.9], in: [0, 0], out: [119.4, -216.9] },
            { p: [628.1, 368.5], in: [0, 0], out: [0, 0] },
            { p: [1922.2, 1640.6], in: [-568.1, 0], out: [568.1, 0] },
            { p: [3220.3, 386.2], in: [0, 0], out: [0, 0] },
            { p: [3490.8, 384.8], in: [-117.1, -161.7], out: [0, 0] },
          ],
          closed: false,
        },
        keys: {
          "Move Carousel": [
            {
              ...
              easeOut: { speed: 313.701996, influence: 0.133267 },
            },
            {
              time: 1.53333,
              value: 80,
              flags: "02020000",
              easeIn: { speed: 180.376957, influence: 0.200029 },
...
<div
  data-composition-id="carousel-path-2"
  data-composition-src="compositions/carousel-path-2.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
