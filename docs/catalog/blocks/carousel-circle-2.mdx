...
<CatalogDetail
  ...
  compositionSrc="compositions/carousel-circle-2.html"
  title="Circle Carousel 2"
  description="Image cards ride a circle with a size gradient by depth angle, sweeping in fast-slow-fast swings (Circle style 2); 12 image slots."
...
>
  <head>
    ...
    <title>Image Carousel · Circle 2</title>
  ...
  <body>
    <div
      data-hf-id="hf-0m1b"
      id="root"
      data-composition-id="carousel-circle-2"
      data-start="0"
      data-width="1920"
      data-height="1080"
      data-duration="6"
    ...
    >
      <div id="carousel-circle-2-partA" class="clip" data-start="0" data-duration="6">
        <div data-hf-id="hf-elyu" id="carousel-circle-2-scaler" class="scaler">
          <div data-hf-id="hf-mi5e" id="carousel-circle-2-stage" class="stage"></div>
        </div>
      </div>
    </div>
...
<div
  data-composition-id="carousel-circle-2"
  data-composition-src="compositions/carousel-circle-2.html"
  data-start="0"
  data-duration="6"
  data-track-index="1"
  data-width="1920"
